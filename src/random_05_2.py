...
def random_benchmark(vertices, density, size_of_Q=5, number=5):
    ...
    for i in range(1, 11):
        ...
        file1 = "/home/elmagico/OPM/benchmarks/benchmarking_random_05_2"+ str(number) + ".txt"
        file2 ="/home/elmagico/OPM/benchmarks/benchmarking_edges_per_node_random_05_2" + str(number) + ".txt"
        if base == gred:
...
if __name__ == "__main__":
    random_benchmark(vertices=10000, density=0.5)
