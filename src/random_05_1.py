...
def random_benchmark(vertices, density, size_of_Q=5):
    ...
    for i in range(1, 51):
        ...
        if base == gred:
            with open("/home/elmagico/OPM/benchmarks/benchmarking_random_05.txt", mode='a') as f:
        ...
        with open("/home/elmagico/OPM/benchmarks/benchmarking_edges_per_node_random_05_1.txt", mode='a') as f:
            writer = csv.writer(f, dialect="excel", delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
