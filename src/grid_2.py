...
def grid_benchmark(vertices_per_axis, size_of_Q=5):
    ...
    for i in range(1, 51):
        ...
        if gred == base:
            with open("/home/elmagico/OPM/benchmarks/benchmarking_grid_2.txt", mode='a') as f:
        ...
        with open("/home/elmagico/OPM/benchmarks/benchmarking_edges_per_node_grid_2.txt", mode='a') as f:
            writer = csv.writer(f, dialect="excel", delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
